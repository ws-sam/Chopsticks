...
const TUTORIALS: Tutorial[] = [
  {
    ...
    preview: '/images/preview-setup.svg?v=10',
  ...
  },
  {
    ...
    preview: '/images/preview-moderation.svg?v=10',
  ...
  },
  {
    ...
    icon: CoinIcon,
    title: 'Economy Setup',
    preview: '/images/preview-economy.svg?v=10',
  ...
  },
  {
    ...
    icon: RadioIcon,
    title: 'Agent System',
    preview: '/images/preview-agents.svg?v=10',
  ...
  },
  {
    ...
    preview: '/images/preview-theme.svg?v=10',
  ...
  },
  {
    ...
    preview: '/images/preview-welcome.svg?v=10',
  ...
  },
  {
    ...
    icon: MusicIcon,
    title: 'Music & Voice',
    preview: '/images/preview-music.svg?v=10',
  ...
  },
  {
    ...
    icon: GamepadIcon,
    title: 'Fun & Games',
    preview: '/images/preview-fun.svg?v=10',
  ...
  },
  {
    ...
    icon: ServerIcon,
    title: 'Self-Hosting',
    preview: '/images/preview-selfhost.svg?v=10',
